...
evaluated.
This vulnerability class is corroborated at industry scale: OpenClaw, the
most widely adopted open-source MCP agent framework as of 2026
(346{,}000+ GitHub stars), required three successive security patches
(v0.3.3, v0.4.1, v0.4.2) following a February~2026 Microsoft security
advisory addressing overly permissive default tool-execution
policies~[R55], reinforcing that the mandatory human-confirmation gate
and \texttt{injection\_scan\_flag} scanning specified for the CWB agent
(Section~\ref{sec:optional-agent}) target an actively exploited
vulnerability class rather than a hypothetical risk.
...
\item Microsoft Security, ``Running OpenClaw Safely: Identity, Isolation, and Runtime Risk,'' Microsoft Security Blog, February~2026; OpenClaw Project, security advisories addressing permissive default tool-execution policies (releases v0.3.3, v0.4.1, v0.4.2), 2026. [Online]. Available: \url{https://www.microsoft.com/en-us/security/blog/2026/02/19/running-openclaw-safely-identity-isolation-runtime-risk/}. Accessed: June~9, 2026.
