...
\noindent\textit{Microsoft Word (.docx) versions of course and project reports are available at \href{https://github.com/Yuvraajrahman/Cryto-World-Bank/tree/main/Documentation/All\%20DOCX\%20files}{Documentation/All DOCX files}.}
...
This project has been developed in conjunction with three undergraduate courses at BRAC University. The following course reports document the database design, software engineering methodology, and system analysis for the Crypto World Bank platform:

\begin{itemize}[noitemsep]
\item \textbf{CSE370 -- Database Management:} Relational schema design, ER/EER modeling, normalization, and indexing. \href{https://github.com/Yuvraajrahman/Cryto-World-Bank/blob/main/Documentation/CSE370_DATABASE_MANAGEMENT\%20REPORT.md}{View report}
\item \textbf{CSE470 -- Software Engineering:} Agile methodology, sprint planning, user stories, and SDLC practices. \href{https://github.com/Yuvraajrahman/Cryto-World-Bank/blob/main/Documentation/CSE470_SOFTWARE_ENGINEERING\%20REPORT.md}{View report}
\item \textbf{CSE471 -- System Analysis and Design:} Use cases, sequence diagrams, activity diagrams, and component architecture. \href{https://github.com/Yuvraajrahman/Cryto-World-Bank/blob/main/Documentation/CSE471_SYSTEM_ANALYSIS_AND_DESIGN\%20REPORT.md}{View report}
\end{itemize}

\noindent\textit{Microsoft Word (.docx) versions: \href{https://github.com/Yuvraajrahman/Cryto-World-Bank/tree/main/Documentation/All\%20DOCX\%20files}{All DOCX files}.}
...
The complete project source code, smart contracts, frontend, backend, and documentation are available in the \href{https://github.com/Yuvraajrahman/Cryto-World-Bank/tree/main}{main repository} (\href{https://github.com/Yuvraajrahman/Cryto-World-Bank/tree/main/Documentation/All\%20DOCX\%20files}{Microsoft Word report versions}).
