...
### Level 1 DFD — Part 1 (Core Loan Processing and Supporting Services)
...
flowchart TD
    ...
    %% Context to Part 2 extended services (see Figure dfd-level1b)
    D1 -.->|"loan context"| P2
...
**Data Stores (Part 1):**
D1: LOAN_REQUEST — D2: TRANSACTION — D3: AI_ML_SECURITY_LOG — D4: BORROWING_LIMIT — D5: BORROWER — D10: MARKET_DATA — D11: INSTALLMENT

---

### Level 1 DFD — Part 2 (Extended Services)
...
**Data Stores (Part 2):**
D6: CHAT_MESSAGE — D7: INCOME_PROOF — D8: AI_CHATBOT_LOG — D9: PROFILE_SETTINGS (shared with Part 1: D1, D4, D5)
