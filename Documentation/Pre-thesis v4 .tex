...
% Hint for bitmaps without explicit dimensions (PNG pixel box)
\pdfimageresolution=600
% Use the full text area (width and height) so raster tables/diagrams are as large as possible
\newcommand{\ImageMaxFit}[1]{%
  \includegraphics[width=\linewidth,height=\dimexpr\textheight-0.5\baselineskip\relax,keepaspectratio]{#1}%
}
...
\newcommand{\OnePageDiagram}[2][]{%
    \includegraphics[#1,width=\linewidth,height=\dimexpr\textheight-2\baselineskip\relax,keepaspectratio]{#2}%
}
...
\begin{table}[H]
\centering
\ImageMaxFit{2.1.1.png}
\TableScreenshotEnd[tab:lit-summary]
\end{table}

\begin{table}[H]
\centering
\ImageMaxFit{2.1.2.png}
\TableScreenshotEnd
\end{table}

\begin{table}[H]
\centering
\ImageMaxFit{2.1.3.png}
\TableScreenshotEnd
\end{table}

\begin{table}[H]
\centering
\ImageMaxFit{2.1.4.png}
\TableScreenshotEnd
\end{table}

\begin{table}[H]
\centering
\ImageMaxFit{2.1.5.png}
\TableScreenshotEnd
\end{table}
...
\begin{figure}[H]
\centering
\ImageMaxFit{Component Diagram.png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{Core System Graph.png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{ERD diagram database management.png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{EER Diagram - Full Model.png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{Usecase diagram.png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{Dataflow Diagram (Context Diagram Level - 0).png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{Data flow diagram (level - 1).png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{dataflow diagram 2 (level -1).png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{Sequence Diagram 1 Loan Request, AI Risk Check, and Approval Decision.png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{Sequence Diagram 1B Reject Path - alt Reject.png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{Sequence Diagram 2 Installment Payment Loop.png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{Sequence Diagram 3 Income Verification.png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{Sequence Diagram 4 Chat System.png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{Sequence Diagram 5 AI Chatbot Interaction.png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{Sequence Diagram 6 Hierarchical Banking.png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{Sequence Diagram 7 Market Data Retrieval.png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{Sequence Diagram 8 Borrowing Limit Calculation.png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{Agile Process Diagram.png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{Sprint submission Diagram.png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{SDLC stage mapping.png}
...
\begin{figure}[H]
\centering
\ImageMaxFit{Design Decisions and Alternatives Considered.png}
...
\begin{table}[H]
\centering
\ImageMaxFit{5.4.1.png}
\TableScreenshotEnd[tab:competitor-detailed]
\end{table}

\begin{table}[H]
\centering
\ImageMaxFit{5.4.2.png}
\TableScreenshotEnd
\end{table}

\begin{table}[H]
\centering
\ImageMaxFit{5.4.3.png}
\TableScreenshotEnd
\end{table}
