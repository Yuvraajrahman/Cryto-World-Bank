...
\usepackage{graphicx}
% Asset paths: PDF is built from ``v30 in development/''; diagrams live under Documentation/Diagrams/
\newcommand*{\ThesisDiagImp}{../Diagrams/mermaid-pdf/improved diagrams/}
\newcommand*{\ThesisDiagPdf}{../Diagrams/mermaid-pdf/}
\newcommand*{\ThesisDiagPng}{../Diagrams/PNGs/}
\newcommand*{\ThesisDiagRoot}{../Diagrams/}
\newcommand*{\ThesisAssetUpTwo}{../../}% Improvements/ (bracu_logo_12-0-2022.png)
\newcommand*{\ThesisAssetUpThree}{../../../}% Documentation/ (logo + shared assets)
\graphicspath{%
  {./}%
  {\ThesisAssetUpTwo}%
  {\ThesisAssetUpThree}%
  ...
  {\ThesisDiagPdf}%
  {\ThesisDiagPng}%                             Chapter PNG exports
  {\ThesisDiagRoot}%
  {Tables/}%
...
\newcommand{\ThesisIncludeGraphics}[2][]{%
  \IfFileExists{\ThesisDiagPng#2}{%
    \@thesis@doinclude{#1}{\ThesisDiagPng#2}}{%
  ...
  \IfFileExists{./#2}{%
    \@thesis@doinclude{#1}{#2}}{%
  \IfFileExists{\ThesisAssetUpTwo#2}{%
    \@thesis@doinclude{#1}{\ThesisAssetUpTwo#2}}{%
  \IfFileExists{\ThesisAssetUpThree#2}{%
    \@thesis@doinclude{#1}{\ThesisAssetUpThree#2}}{%
...
\begin{figure}[H]
\centering
\BalancedDiagram{Chapter1_diagram1.png}
...
\begin{figure}[H]
\centering
\BalancedDiagram{Chapter1_diagram2.png}
...
\begin{figure}[H]
\centering
\BalancedDiagram{Chapter1_diagram3.png}
...
\textbf{LOAN\_REQUEST} records the application and approval workflow; approved
requests produce \textbf{LOAN}.
\textbf{LOAN} is the lifecycle hub for \texttt{INSTALLMENT} (weak entity; composite
key \texttt{loan\_id}~+~\texttt{installment\_number}) and \texttt{AI\_ML\_LOG}
(risk scoring).
\texttt{CHAT\_MESSAGE} records client--bank communication, linked to the active
\texttt{LOAN\_REQUEST} or \texttt{LOAN} context.
...
SESSIONS & \texttt{session\_id} & Formal session management: wallet address, device hash, IP address,
...
\item \textbf{Tier~1--3 institutional:}
\[
...
\begin{figure}[H]
\centering
\HalfWidthDiagram{fig-savings-vault.pdf}
...
\begin{figure}[H]
\centering
\BalancedDiagram[width=0.98\linewidth]{fig-usecase-actors.pdf}
...
\noindent The auxiliary contract modules introduced in Sections~\ref{sec:liquidation}--\ref{sec:bridge} (Figures~\ref{fig:liquidation-engine}, \ref{fig:savings-vault}, \ref{fig:credit-passport}, and \ref{fig:ccip-bridge}) are integrated here with the broader banking-product suite described below.
...
\item Federal Reserve Bank of New York and Bank for International Settlements Innovation Hub, ``Project Pine: Central Bank Open Market Operations with Smart Contracts,'' BIS Innovation Hub / NY Fed Joint Report, May 2025. [Online]. Available: \url{https://www.bis.org/publ/othp95.htm}
...
\item U.~Bindseil, ``Tiered CBDC and the Financial System,'' \textit{ECB Working Paper Series}, no.~2351, January 2020. [Online]. Available: \url{https://www.ecb.europa.eu/pub/pdf/scpwps/ecb.wp2351~c8c18bbd60.en.pdf}
...
\item R.~Auer and R.~B\"{o}hme, ``The Technology of Retail Central Bank Digital Currency,'' \textit{BIS Quarterly Review}, March 2020; see also BIS Working Paper No.~948. [Online]. Available: \url{https://www.bis.org/publ/qtrpdf/r_qt2003j.htm}
...
\item W.~Du, C.~Huang, and D.~Scharfstein, ``Competing Rails for Cross-Border Payments: Banks, Fintechs, and Stablecoins,'' Harvard Business School Working Paper, February 2026. [Online]. Available: \url{https://www.hbs.edu/faculty/Pages/item.aspx?num=66992}

\item M.~Fr\"{o}hlich, J.~A.~Vega Vermehren, F.~Alt, and A.~Schmidt, ``Implementation and Evaluation of a Point-Of-Sale Payment System Using Bitcoin Lightning,'' in \textit{Proc. NordiCHI}, 2022. [Online]. Available: \url{http://www.medien.ifi.lmu.de/pubdb/publications/pub/froehlich2022nordichi/froehlich2022nordichi.pdf}
...
\item J.~Lin, M.~Liu, S.~Li, and X.~Wang, ``SecurePay: Enabling Secure and Fast Payment Processing for Platform Economy,'' in \textit{Proc. IEEE/ACM Int. Symp. Quality of Service (IWQoS)}, 2025; \textit{arXiv:2505.17466}. [Online]. Available: \url{https://arxiv.org/abs/2505.17466}

\item Committee on Payments and Market Infrastructures, ``Considerations for the Use of Stablecoin Arrangements in Cross-Border Payments,'' Bank for International Settlements, July 2023. [Online]. Available: \url{https://www.bis.org/cpmi/publ/d220.pdf}

\item A.~Kosse, J.~Lisack, and N.~Boakye-Agyeman, ``The Impact of Stablecoins on the International Monetary and Financial System,'' \textit{BIS Papers}, no.~170, February 2023. [Online]. Available: \url{https://www.bis.org/publ/bppdf/bispap170.pdf}

\item E.~Cerutti, M.~Firat, and H.~P\'{e}rez-Saiz, ``Estimating the Impact of Digital Money on Cross-Border Flows: Scenario Analysis Covering the Intensive Margin,'' \textit{IMF Fintech Notes}, 2025/002, February 2025. [Online]. Available: \url{https://www.imf.org/-/media/files/publications/ftn063/2025/english/ftnea2025002.pdf}

\item Financial Action Task Force, ``Updated Guidance for a Risk-Based Approach to Virtual Assets and Virtual Asset Service Providers,'' FATF, Paris, October 2021. [Online]. Available: \url{https://www.fatf-gafi.org/en/publications/Fatfrecommendations/Va-Vasp-Guidance-R16-R21.html}

\item G.~Cimaszewski, F.~Da Dalt, T.~Moser, and A.~Perrig, ``SCION and Cross-Border Payments: Enhancing Security and Compliance in Distributed Ledger Networks,'' \textit{SNB Working Papers}, 15/2025, Swiss National Bank. [Online]. Available: \url{https://www.snb.ch/en/publications/research/working_papers/working_papers_2025}

\item Bank for International Settlements Innovation Hub, ``Project Sela: An Accessible and Secure Retail CBDC Ecosystem,'' BIS, 2024. [Online]. Available: \url{https://www.bis.org/publ/othp74.htm}
