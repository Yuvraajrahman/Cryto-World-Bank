...
export function Landing() {
    return (_jsxs("div", { className: "flex min-h-screen flex-col", children: [_jsx(PublicHeader, {}), _jsx(Hero, {}), _jsx(TrustStrip, {}), _jsx(Features, {}), _jsx(LandingAssistantSection, {}), _jsx(Hierarchy, {}), _jsx(Security, {}), _jsx(Numbers, {}), _jsx(CTA, {}), _jsx(Footer, {})] }));
}
function Hero() {
