...
export function Wordmark({ className }) {
    return (_jsxs("div", { className: cn("flex items-center gap-2.5 select-none", className), children: [_jsx(Logo, { size: 34 }), _jsxs("div", { className: "flex flex-col leading-none", children: [_jsx("span", { className: "font-display text-xl font-semibold tracking-wide gold-text", children: "Crypto World Bank" }), _jsx("span", { className: "text-[11px] uppercase tracking-[0.25em] text-ink-200", children: "Decentralized \u00B7 Reserve" })] })] }));
}
