...
\begin{tikzpicture}[remember picture,overlay]
    ...
    \fill[AccentBlue] ([yshift=-6cm]current page.north west) rectangle ([yshift=-6.3cm]current page.north east);
\end{tikzpicture}
...
{\color{white}\LARGE\bfseries Decentralized Crypto World Bank}\\[0.4em]
{\color{white!90}\large A Blockchain-Based Hierarchical Lending Platform\\[0.2em]with AI-Enhanced Security}
