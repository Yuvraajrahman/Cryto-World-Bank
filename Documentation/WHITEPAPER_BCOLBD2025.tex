...
% Following BRAC University Pre-Thesis / Final Year Project Template
% ═══════════════════════════════════════════════════════════════════
% MODERNIZED LaTeX — Feb 2026
% ═══════════════════════════════════════════════════════════════════

\documentclass[11pt,a4paper]{article}

% ── Core Encoding & Typography ─────────────────────────────────────
...
\hangindent=0.5in \textbf{Identified Gaps.} Across these 17 papers, four gaps motivate the Crypto World Bank: (1) no hierarchical institutional model exists in DeFi lending [10, 1, 9]; (2) limited integration of AI/ML security analytics with DeFi lending [2, 3, 16]; (3) insufficient explainability in automated lending decisions [4, 11, 17]; and (4) inadequate governance frameworks for multi-tier decentralized finance systems [14].
...
\begin{tabular}{@{} >{\raggedright}p{2.4cm} >{\raggedright}p{3.2cm} c >{\raggedright\arraybackslash}p{4.2cm} @{}}
\toprule
\tableheadfont Risk Category & \tableheadfont Description & \tableheadfont Sev. & \tableheadfont Mitigation \\
\midrule
\rowcolor{RowShade}
Partner non-cooperation & Key ecosystem partners decline to participate & {\color{AmberAccent}\textbf{M}} & Initiate with low-barrier academic and NGO pilots; minimize switching costs \\
Incentive misalignment & Participant incentives diverge from network objectives & {\color{AmberAccent}\textbf{M}} & Codify rules in smart contracts; implement governance token alignment (future) \\
\rowcolor{RowShade}
Smart contract vulnerability & Exploit in contract logic (reentrancy, overflow) & {\color{RedAccent}\textbf{H}} & OpenZeppelin security primitives; formal audit (planned); pause mechanism \\
Regulatory adversity & Jurisdictional restrictions on crypto lending & {\color{AmberAccent}\textbf{M}} & Operate exclusively on testnets during prototype phase; engage regulatory sandbox programs \\
\rowcolor{RowShade}
Market adoption failure & Insufficient user or institutional traction & {\color{GreenAccent}\textbf{L}} & Leverage academic and competition channels; open-source codebase \\
AI/ML model degradation & Fraud detection accuracy decays over time & {\color{GreenAccent}\textbf{L}} & Continuous model retraining pipeline; human-in-the-loop review; explainability via SHAP \\
\bottomrule
\end{tabular}
\end{moderntable}
...
% ── BAR GRAPH: Interest Rate Spread ─────────────────────────────────
\begin{figure}[H]
\centering
\begin{tikzpicture}
\begin{axis}[
