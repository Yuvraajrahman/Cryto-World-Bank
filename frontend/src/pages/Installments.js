...
import { CalendarClock, CheckCircle2, Coins, CircleDollarSign, AlertTriangle, Clock, Receipt, } from "lucide-react";
                                                    ...
                                                    : isOverdue
                                                        ...
                                                        : "border-ink-600/60"}`, children: [_jsx("span", { "aria-hidden": true, className: `absolute left-2 flex h-4 w-4 items-center justify-center rounded-full border ${x.paid
                                                            ...
                                                            : isOverdue
                                                                ...
                                                                : isOverdue
                                                                    ? "bg-red-300"
                                                                    : "bg-gold-300"}` }) }), _jsxs("div", { className: "flex items-center gap-4", children: [_jsxs("div", { className: "font-mono text-sm text-ink-200", children: ["#", x.index.toString().padStart(2, "0")] }), _jsxs("div", { children: [_jsxs("div", { className: "flex items-center gap-2 text-sm text-ink-100", children: [_jsx(CalendarClock, { className: "h-3.5 w-3.5 text-gold-400" }), d.toLocaleDateString(), !x.paid ? (_jsxs("span", { className: `text-xs ${isOverdue ? "text-red-300" : "text-ink-200"}`, children: ["\u00B7 ", isOverdue ? `overdue ${-days}d` : `${days}d`] })) : null] }), x.txHash ? (_jsxs("div", { className: "mt-0.5 font-mono text-[11px] text-ink-200", children: ["tx ", x.txHash.slice(0, 10), "\u2026", x.txHash.slice(-4)] })) : (_jsx("div", { className: "mt-0.5 text-xs text-ink-200", children: isOverdue ? (_jsxs("span", { className: "inline-flex items-center gap-1 text-red-300", children: [_jsx(AlertTriangle, { className: "h-3 w-3" }), " Overdue"] })) : (_jsxs("span", { className: "inline-flex items-center gap-1", children: [_jsx(Clock, { className: "h-3 w-3" }), " Awaiting payment"] })) }))] })] }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsxs("span", { className: "font-mono text-sm text-ink-100", children: [x.amount.toFixed(4), " ETH"] }), x.paid ? (_jsxs("span", { className: "badge-green", children: [_jsx(CheckCircle2, { className: "h-3.5 w-3.5" }), "Paid"] })) : (_jsxs("button", { className: "btn-ghost text-xs", onClick: () => pay(x.index), disabled: paying !== null, children: [_jsx(Coins, { className: "h-3.5 w-3.5" }), paying === x.index ? "Paying…" : "Pay"] }))] })] }, x.index));
