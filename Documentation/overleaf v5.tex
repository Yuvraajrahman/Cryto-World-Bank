...
% ============================================================
% Overleaf fast compile switches (independent toggles)
% - Drafting images makes compiles faster but hides the images.
% - Disabling TikZ/PGFPlots keeps images, but replaces drawn figures with a placeholder.
%
% Recommended for Overleaf free plan:
%   \OverleafDraftImagesfalse       % show images (draft hides them)
%   \OverleafDisableTikZtrue        % disable expensive TikZ/PGFPlots
%   \ThesisPreferCompressedImagestrue % load JPEGs from compressed/ first (see compress_images_for_overleaf.py)
% ============================================================
\newif\ifOverleafDraftImages
\newif\ifOverleafDisableTikZ
\newif\ifThesisPreferCompressedImages
\OverleafDraftImagesfalse
\OverleafDisableTikZtrue
% Prefer mirrored low-res JPEGs under compressed/Tables/..., compressed/Diagrams/... when present (see compress_images_for_overleaf.py).
\ThesisPreferCompressedImagestrue
\ifOverleafDraftImages
...
\usepackage{graphicx}
% Prefer a lightweight image set (upload to Overleaf as folder "compressed/")
\graphicspath{{compressed/}{./}{Tables/}{Diagrams/}{Diagrams/CSE370/}{Diagrams/CSE471/}{Diagrams/CSE470/}}
...
\newcommand*{\@thesis@maybeinclude}[3]{%
  \IfFileExists{#2}{\@thesis@doinclude{#1}{#2}\def#3{1}}{}%
}
\newcommand*{\@thesis@altcandidates}[2]{%
  % #1 = requested filename (may include extension), #2 = macro to receive base (no ext)
  \filename@parse{#1}%
  \edef#2{\filename@base}%
}
\newcommand{\ThesisIncludeGraphics}[2][]{%
  % Fast Overleaf trick: smaller JPEGs under compressed/ mirror Tables/ and Diagrams/ (see compress_images_for_overleaf.py).
  % Search order when \ThesisPreferCompressedImagestrue: compressed tree first (same relative paths), then originals.
  \begingroup
  \def\thesis@done{0}%
  \def\thesis@base{}%
  \@thesis@altcandidates{#2}{\thesis@base}%

  \ifThesisPreferCompressedImages
    \@thesis@maybeinclude{#1}{compressed/#2}{\thesis@done}%
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/./#2}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Tables/#2}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/#2}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/CSE370/#2}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/CSE471/#2}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/CSE470/#2}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/\thesis@base.jpg}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/./\thesis@base.jpg}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Tables/\thesis@base.jpg}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/\thesis@base.jpg}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/CSE370/\thesis@base.jpg}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/CSE471/\thesis@base.jpg}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/CSE470/\thesis@base.jpg}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/\thesis@base.jpeg}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/./\thesis@base.jpeg}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Tables/\thesis@base.jpeg}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/\thesis@base.jpeg}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/CSE370/\thesis@base.jpeg}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/CSE471/\thesis@base.jpeg}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/CSE470/\thesis@base.jpeg}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/\thesis@base.png}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/./\thesis@base.png}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Tables/\thesis@base.png}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/\thesis@base.png}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/CSE370/\thesis@base.png}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/CSE471/\thesis@base.png}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/CSE470/\thesis@base.png}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/\thesis@base.pdf}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/./\thesis@base.pdf}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Tables/\thesis@base.pdf}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/\thesis@base.pdf}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/CSE370/\thesis@base.pdf}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/CSE471/\thesis@base.pdf}{\thesis@done}\fi
    \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{compressed/Diagrams/CSE470/\thesis@base.pdf}{\thesis@done}\fi
  \fi

  % Original-resolution tree (fallback if no compressed copy exists)
  \@thesis@maybeinclude{#1}{#2}{\thesis@done}%
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{./#2}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Tables/#2}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/#2}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/CSE370/#2}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/CSE471/#2}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/CSE470/#2}{\thesis@done}\fi

  % Alternate extensions (e.g. thesis references .png but only .jpg exists)
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{\thesis@base.jpg}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{./\thesis@base.jpg}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Tables/\thesis@base.jpg}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/\thesis@base.jpg}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/CSE370/\thesis@base.jpg}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/CSE471/\thesis@base.jpg}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/CSE470/\thesis@base.jpg}{\thesis@done}\fi

  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{\thesis@base.jpeg}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{./\thesis@base.jpeg}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Tables/\thesis@base.jpeg}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/\thesis@base.jpeg}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/CSE370/\thesis@base.jpeg}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/CSE471/\thesis@base.jpeg}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/CSE470/\thesis@base.jpeg}{\thesis@done}\fi

  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{\thesis@base.png}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{./\thesis@base.png}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Tables/\thesis@base.png}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/\thesis@base.png}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/CSE370/\thesis@base.png}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/CSE471/\thesis@base.png}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/CSE470/\thesis@base.png}{\thesis@done}\fi

  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{\thesis@base.pdf}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{./\thesis@base.pdf}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Tables/\thesis@base.pdf}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/\thesis@base.pdf}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/CSE370/\thesis@base.pdf}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/CSE471/\thesis@base.pdf}{\thesis@done}\fi
  \ifnum\thesis@done=0\relax \@thesis@maybeinclude{#1}{Diagrams/CSE470/\thesis@base.pdf}{\thesis@done}\fi

  \ifnum\thesis@done=0\relax
    \@thesismissingimg{#2}%
  \fi
  \endgroup
}
...
% PDF size compression (affects output size more than compile time)
\pdfcompresslevel=9
\pdfobjcompresslevel=3

\ifOverleafDisableTikZ
  % Replace TikZ/PGFPlots render cost with a cheap placeholder box.
  % (Keeps figure numbering/captions intact.)
  \RenewDocumentEnvironment{tikzpicture}{ O{} +b }{%
    \begin{center}
      \fbox{\parbox{0.92\linewidth}{\scriptsize\centering TikZ/PGFPlots disabled (fast compile mode).}}
    \end{center}
  }{}
\fi
