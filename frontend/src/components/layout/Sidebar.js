...
const nav = [
    ...
    { to: "/bank/world/facilities", label: "World facilities", icon: PiggyBank, roles: ["OWNER"] },
    { to: "/bank/national/facilities", label: "National facilities", icon: PiggyBank, roles: ["NATIONAL_BANK_ADMIN"] },
    { to: "/bank/local/facilities", label: "Local facilities", icon: PiggyBank, roles: ["LOCAL_BANK_ADMIN"] },
    { to: "/app/loans/history", label: "My Loans", icon: Coins, roles: ["BORROWER"] },
    { to: "/app/loans/apply", label: "Request Loan", icon: FilePlus2, roles: ["BORROWER"] },
    { to: "/bank/local/approvals", label: "Approvals Queue", icon: Inbox, roles: ["APPROVER", "LOCAL_BANK_ADMIN"] },
    { to: "/bank/national/approvals", label: "Approvals Queue", icon: Inbox, roles: ["NATIONAL_BANK_ADMIN"] },
    { to: "/app/installments", label: "Installments", icon: Receipt, roles: ["BORROWER"] },
    ...
    { to: "/app/risk", label: "Risk Console", icon: ShieldAlert, roles: ["OWNER", "NATIONAL_BANK_ADMIN", "LOCAL_BANK_ADMIN"] },
    { to: "/app/settings", label: "Profile", icon: UserRound, roles: ALL },
    { to: "/app/admin", label: "Admin", icon: Settings2, roles: ["OWNER"] },
    { to: "/bank/world/multisig", label: "Multisig", icon: Shield, roles: ["OWNER"] },
];
