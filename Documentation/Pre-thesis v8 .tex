...
\begin{table}[H]
\centering
\caption{Prototype scope: feature implementation status as of pre-thesis submission. ✅ = Implemented and testnet-verified; ⏳ = Designed or partially scaffolded; 🔵 = Planned for final thesis phase.}
